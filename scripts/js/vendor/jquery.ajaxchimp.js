        ...
        var deferreds = $(this).map(function(i, elem) {
            ...
            form.on('submit', function (event) {
                ...
                $.ajax({
                    ...
                    if (data.result === 'success') {
                        ...
                        if (success_div.length !== 0) {
                            ...
                            // error_div.text('').hide();
                            success_div.text(msg).fadeIn(500).delay(3000).fadeOut(500);
                        }
                    } else{
                        ...
                        if (error_div.length !== 0) {
                            ...
                            error_div.text(msg).fadeIn(500).delay(3000).fadeOut(500);
                        }
                    }
                ...
                if (success_div.length !== 0) {
                    ...
                    // error_div.text('').hide();
                    // success_div.text(submitMsg).fadeIn(250, function(){ console.log('2');$(this).delay(2000).fadeOut(250); })
                }
            });
            return deferred;
        });
